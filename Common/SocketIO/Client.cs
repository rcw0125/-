...
namespace SocketIOClient
{
	...
	public class Client : IDisposable, SocketIOClient.IClient
	{
		...
		private int retryConnectionAttempts = 10000;
        ...
        public event EventHandler CallConnect;
		/// <summary>
		...
		public bool IsConnected
		{
			get
			{
                return (this.ReadyState == WebSocketState.Connecting || this.ReadyState == WebSocketState.Open);
			}
		}
		...
		protected void ReConnect()
		{
			...
			{	// we didn't connect - try again until exhausted
				...
				if (IsRepeat|| (this.retryConnectionCount < this.RetryConnectionAttempts))
				{
					this.ReConnect();
				}
				else
				{
                    ...
                    CallConnect(this, EventArgs.Empty);
				}
			}
		}
